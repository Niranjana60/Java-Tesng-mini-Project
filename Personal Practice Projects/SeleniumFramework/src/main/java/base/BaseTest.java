...
public class BaseTest {
	...
	public void beforeTestMethod() {
		...
		extent.setSystemInfo("HostName", "DESKTOP-TU1VJ5V");
		extent.setSystemInfo("UserName", "nirur");
	...
	public void afterMethod(ITestResult result) {
		if (result.getStatus() == ITestResult.FAILURE) {
			...
			logger.log(Status.SKIP, MarkupHelper.createLabel(result.getName() + "-Test case Pass", ExtentColor.GREEN));
		}
